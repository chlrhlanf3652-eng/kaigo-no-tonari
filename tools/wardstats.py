...
def reception(closed: str) -> str:
    """受付休業日の書き方から、受付体制を分ける。

    空文字を「土日も受付」と判定してしまうと、データが無いだけの事業所を
    「土日も受け付ける」と断定することになる。無い場合は無いと書く。
    """
...
RECV_DESC = {
    ...
    "情報なし": "掲載元のデータに受付体制の記載がないもの。各事業所へご確認ください",
}
RECV_ORDER = ["年中無休", "土日も受付", "平日中心", "情報なし"]
